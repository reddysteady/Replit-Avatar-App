...
// Enhanced badge progress calculation with logging and null handling
export function calculateBadgeProgress(
  config: Partial<AvatarPersonaConfig>,
  conversationHistory: string[] = []
): BadgeSystemState {
  console.log('[BADGE-VALIDATION] Input config:', config)
  console.log('[BADGE-VALIDATION] Conversation history length:', conversationHistory.length)
